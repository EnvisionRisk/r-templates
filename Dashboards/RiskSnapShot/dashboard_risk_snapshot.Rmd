...
The dashboard is created based on the settings below. It consist of 2 pages: A 'Summary' page and a 'Risk Decomposition' page. The 'Summary' page (the page you are on) contains the settings used for the creation of the dashboard as well as the portfolio profit/loss distribution. The page 'Risk Decomposition' contains detailed risk information for the top 10 portfolio positions (by market value and risk). Additionally it contains information about diversification in the portfolio. Use the 'Navigate' drop-down meny at the top of this page to navigate between the pages. In case you have any question or comments to the dashboard please contact EnvisionRisk at info@envisionrisk.com.
...
Some commentary about the asset allocation & Diversification.
