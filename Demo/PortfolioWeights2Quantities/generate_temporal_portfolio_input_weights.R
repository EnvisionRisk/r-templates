...
#my_port_weight <- data.table::data.table(dt_realistic_port[,.(symbol, weight)])
...
dates <- c(paste0(2018, c("-01-02" , "-03-30", "-06-30", "-09-30", "-12-31")),
           ...
           paste0(2023, c("-03-31" , "-06-30", "-09-30")))
...
#saveRDS(dt_port, paste0(getwd(), "/Data/pension_port_weights.rds"))
...
#saveRDS(dt_port_w, paste0(getwd(), "/Data/pension_port_weights_wide.rds"))
